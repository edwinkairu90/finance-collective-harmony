...
export const ScenarioLineItemsRow: React.FC<ScenarioLineItemsRowProps> = ({
  ...
  const baseValue = department 
    ? baseScenario.budgetImpact.departments?.[department]?.budget || 0
    : baseScenario.budgetImpact[accessor as keyof typeof baseScenario.budgetImpact] || 0;
    
  const compareValue = department 
    ? compareScenario.budgetImpact.departments?.[department]?.budget || 0
    : compareScenario.budgetImpact[accessor as keyof typeof compareScenario.budgetImpact] || 0;
